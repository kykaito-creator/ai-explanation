const roadmapSlides = [
  {
    ...
    badge: "講義",
    title: "この授業でできること",
    headline: "運用・構築の全体像をつかむ",
    goal: "対象者と到達点を明確にする。",
    paragraphs: [
      "対象: [[AI運用初心者]]〜[[チーム導入を考える人]]。",
      "ゴール: [[全体マップ]]を理解し、[[いつ何を決めるか]]が見えるようにする。",
      "現場感: 仕組みだけでなく[[判断順序]]を重視する。",
      "最後に[[自分のロードマップ]]を作る。"
    ],
    details: {
      "AI運用初心者": "これから運用設計に触れる人。",
      "チーム導入を考える人": "複数人での運用を想定する人。",
      "全体マップ": "構築から運用までの流れ。",
      "いつ何を決めるか": "意思決定の順序を把握すること。",
      "判断順序": "迷わないための決定の並べ方。",
      "自分のロードマップ": "自分の状況に合わせた計画。"
    }
  },
  {
    id: 900,
    ...
    badge: "講義",
    title: "ロードマップの全体像",
    headline: "決める順番が成功率を上げる",
    goal: "各フェーズの決定事項を整理する。",
    paragraphs: [
      "Phase1: [[目的]]と[[対象ユーザー]]を決める。",
      "Phase2: [[環境]]と[[コスト上限]]を決める。",
      "Phase3: [[モデル]]と[[データ]]を選ぶ。",
      "Phase4: [[監視]]と[[改善サイクル]]を回す。"
    ],
    details: {
      "目的": "何を実現したいかのゴール。",
      "対象ユーザー": "誰に向けた機能か。",
  ...
  },
  {
    ...
    badge: "講義",
    title: "運用で起きる3大リスク",
    headline: "先に備えれば失敗は減る",
    goal: "リスクと対策をセットで理解する。",
    paragraphs: [
      "[[セキュリティ]]: 権限を最小化し、[[機密データ]]は隔離する。",
      "[[コスト]]: 事前に[[上限]]を決め、監視で暴走を止める。",
      "[[品質]]: [[テスト]]と[[レビュー]]で検証し続ける。"
    ],
    details: {
      "セキュリティ": "情報漏えい・権限漏れのリスク。",
      "機密データ": "外部に出せない情報。",
      "コスト": "計算資源やAPI利用の費用。",
      "上限": "予算の天井を先に決めること。",
      "品質": "正確性・一貫性・再現性のこと。",
  ...
  },
  {
    ...
    title: "自分のロードマップを作る",
    headline: "決める順番を紙に書く",
    goal: "自分のプロジェクトに当てはめる。",
    paragraphs: [
      "まず[[目的]]と[[対象ユーザー]]を1行で書く。",
      "次に[[環境]]と[[予算]]を決める。",
      "最後に[[評価指標]]と[[運用担当]]を決める。",
      "この順番を守るだけで迷子になりにくい。"
    ],
    details: {
      "目的": "実現したいゴール。",
  ...
  },
  {
    ...
    badge: "講義",
    title: "3行まとめ + 次の行動",
    headline: "決める順番が運用を救う",
    goal: "学びを行動に変える。",
    paragraphs: [
      "まとめ1: まず[[目的]]を固定する。",
      "まとめ2: [[環境]]と[[コスト]]を先に決める。",
      "まとめ3: [[監視]]で品質を維持する。",
      "次の行動: 自分の案件の[[決定順序]]を書き出す。"
    ],
    details: {
      "目的": "やるべきゴール。",
      "環境": "実行基盤の選択。",
