const slides = [
  {
    id: 0,
    section: "オリエンテーション",
    sectionLabel: "オリエンテーション",
    navLabel: "オリエンテーション",
    variant: "overview",
    title: "この授業でできること",
    headline: "ゴールと対象者を先に固定",
    goal: "到達点と対象者を明確にし、学びの軸を揃える。",
    paragraphs: [
      "対象: [[AI初心者]]〜[[自作に挑戦したい人]]。",
      "ゴール: [[モデル選択]]と[[環境の全体像]]を理解し、最初の[[小さな作品]]を作る。",
      "スタイル: 難しい数学ではなく、[[仕組みと運用]]に集中する。",
      "最後に[[最短ルート]]で行動まで落とし込む。"
    ],
    details: {
      "AI初心者": "AIに触れ始めたばかりの人。",
      "自作に挑戦したい人": "自分の手でAI活用を形にしたい人。",
      "モデル選択": "目的に合わせてAIの脳を選ぶこと。",
      "環境の全体像": "OS・GPU・ツールのつながりを把握すること。",
      "小さな作品": "まずは小規模な成果物を作ること。",
      "仕組みと運用": "原理と実務の両方を理解する姿勢。",
      "最短ルート": "迷わず行動に移すための手順。"
    }
  },
  {
  ...
  },
  {
    id: 900,
    section: "AIとの距離感",
    sectionLabel: "AIとの距離感",
    navLabel: "できること/できないこと",
    variant: "overview",
    title: "AIでできること・できないこと",
    headline: "期待値を揃えると失敗が減る",
    goal: "AIの得意不得意を理解して使い分ける。",
    paragraphs: [
      "得意: [[要約]] / [[下書き]] / [[反復作業]] / [[アイデア出し]]。",
      "苦手: [[最新性の保証]] / [[責任判断]] / [[価値観の決定]]。",
      "AIは[[相棒]]、最終判断は[[人間]]が担う。"
    ],
    details: {
      "要約": "長い情報を短く整理する作業。",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "12GBでも動くAIモデルは沢山あるが、最新のAIモデルはほぼ動かせない。",
  ...
  },
  {
    ...
    {
      id: 8.5,
      section: "GPUなしでAIを動かす",
      sectionLabel: "GPUなしでAIを動かす",
      navLabel: "GPUなしでAI",
      variant: "overview",
      title: "GPUがなくてもAIは動く",
      headline: "クラウドと軽量モデルで代替する。",
      goal: "GPUがない場合の選択肢を理解する。",
      paragraphs: [
        "方法1: [[クラウドAPI]]を使う。重い計算は相手側で実行される。",
        "方法2: [[軽量モデル]]をCPUで動かす。速度は遅いが学習には十分。",
        "方法3: [[クラウドGPU]]を短時間レンタル。必要なときだけ借りる。",
        "ポイント: 目的と予算で[[選択肢]]を切り替える。"
      ],
      details: {
        "クラウドAPI": "AIサービスにリクエストして結果を受け取る方法。端末は軽くて済む。",
        "軽量モデル": "小さいモデルを使い、CPUでも動かせる構成。",
        "クラウドGPU": "GPUを時間単位で借りる仕組み。初期投資を抑えられる。",
        "選択肢": "用途・予算・速度の優先度で使い分ける発想。"
      }
    },
    {
      id: 8.6,
      section: "GPUなしでAIを動かす",
      sectionLabel: "GPUなしでAIを動かす / 解説",
      navLabel: "GPUなしでAI（解説）",
      variant: "detail",
      title: "GPUなし運用のコツ",
      headline: "速度とコストのバランスを取る。",
      goal: "CPU運用とクラウド利用の注意点を理解する。",
      paragraphs: [
        "CPU運用は[[量子化]]や[[コンテキスト短縮]]で軽くする。",
        "生成は重い。要約や分類はCPUでも実用的。",
        "クラウドは[[料金]]と[[通信遅延]]に注意する。",
        "機密データは[[匿名化]]や[[ローカル処理]]を検討。"
      ],
      details: {
        "量子化": "モデルを軽くしてCPUで動かしやすくする工夫。",
        "コンテキスト短縮": "一度に渡す情報量を減らして処理を軽くする。",
        "料金": "使った分だけ課金されるため、見積もりが重要。",
        "通信遅延": "ネット越しに処理するため応答が遅くなる場合がある。",
        "匿名化": "個人情報を伏せて扱う方法。",
        "ローカル処理": "ネットに出さずに端末内で処理する運用。"
      }
    },
    {
      id: 6,
  ...
  },
  {
    ...
    variant: "overview",
    title: "5分で体験ワーク",
    headline: "まず1回、AIと作ってみる",
    goal: "短い体験でAIの変化を掴む。",
    paragraphs: [
      "お題: 「[[自分の趣味紹介]]を[[3つの見出し]]で書いて」とAIに依頼。",
      "次に「対象を[[中学生向け]]に変更して」と追加指示。",
      "最後に「[[300文字以内]]に短く」と条件を変える。",
      "出力の変化を観察して、指示の効き方を体感する。"
    ],
    details: {
      "自分の趣味紹介": "身近な内容で試すと変化が分かりやすい。",
      "3つの見出し": "構成指定で文章が整理される。",
      "中学生向け": "対象を変えると語彙が変わる。",
      "300文字以内": "文字数制約で情報量が調整される。"
    }
  },
  {
    id: 11,
  ...
  },
  {
    ...
    goal: "学びを行動に変える。",
    paragraphs: [
      "まとめ1: AIは[[道具]]、使い方で差が出る。",
      "まとめ2: まずは[[小さな課題]]で試す。",
      "まとめ3: 学びは[[作品化]]で定着する。",
      "次の行動: 今日中に[[1つのミニプロジェクト]]を決める。"
    ],
    details: {
      "道具": "目的達成のための手段。",
      "小さな課題": "短時間で終わる練習タスク。",
      "作品化": "アウトプットとして形に残すこと。",
      "1つのミニプロジェクト": "自分で動かせる小さな成果物。"
    }
  },
  {
    id: 12,
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "・自分ならもっとこうするのに",
      "AIで作成しました。っといってもまだ人の作ると言う意思がなければ、何も生成されません。",
      "このWEBサイトと呼べるのかどうかも怪しいサイトは人が作ったのでしょうか？AIが作ったのでしょうか？",
      "解釈には様々な段階があります。自分が今どこにいるのか確認し、背伸びせず確実に次の一歩を進みましょう。"
    ],
    details: {
...
const ttsAutoBtn = document.getElementById("tts-auto-btn");
